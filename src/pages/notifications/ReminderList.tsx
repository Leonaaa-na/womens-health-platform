...
function ReminderList() {
  ...
  const [reminders, setReminders] = useState<HerBloomReminder[]>([]);
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-start justify-between gap-3">
                      <div>
                        ...
                        <span className="text-xs font-semibold text-pink-500 capitalize">
                          {reminder.type}
                        </span>
                      </div>
                      <span
                    ...
                    <div className="mt-4 flex flex-wrap gap-2">
                      <button
                        onClick={() =>
                          navigate(`/notifications/reminders/${reminder.id}/edit`)
                        }
