...
function HospitalBirthPlanning() {
  ...
  const defaultChecklist: ChecklistItem[] = [
    ...
    {
      id: 4,
      name: "Mother's comfortable clothes",
      completed: false,
    },
    {
      id: 5,
  ...
  const [hasHospitalChecklist, setHasHospitalChecklist] = useState<
    boolean | null
  >(null);

  const [checklist, setChecklist] =
    useState<ChecklistItem[]>(defaultChecklist);
  ...
  useEffect(() => {
    ...
    const savedProvider =
      localStorage.getItem("healthcareProvider");

    const savedTransport =
      localStorage.getItem("transportPlan");

    const savedHasChecklist =
      localStorage.getItem("hasHospitalChecklist");

    const savedChecklist =
      localStorage.getItem("hospitalChecklist");

    const savedBirthPreferences =
      localStorage.getItem("birthPreferences");

    const savedContacts =
      localStorage.getItem("birthContacts");

    const savedNotes =
      localStorage.getItem("birthPlanningNotes");
    ...
    if (savedProvider) {
      setHealthcareProvider(savedProvider);
    }

    if (savedTransport) {
      setTransportPlan(savedTransport);
    }

    if (savedHasChecklist !== null) {
      setHasHospitalChecklist(
        savedHasChecklist === "true"
      );
    }
    ...
    if (savedBirthPreferences) {
      setBirthPreferences(savedBirthPreferences);
    }
  ...
  const savePlanning = () => {
    ...
    if (hasHospitalChecklist !== null) {
      localStorage.setItem(
        "hasHospitalChecklist",
        String(hasHospitalChecklist)
      );
    }
    ...
    setSavedMessage(
      "Your hospital and birth plan has been saved."
    );
        ...
        <div className="mx-auto flex max-w-md items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">
              Prepare for your delivery journey
            </p>
          </div>
      ...
      <main className="mx-auto max-w-md space-y-5 px-5 py-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm leading-5 opacity-90">
                Organize your hospital information,
                checklist, contacts and birth preferences
                in one place.
              </p>
            </div>
        ...
        <section className="rounded-3xl bg-white p-5 shadow-sm">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Keep your delivery information handy.
          </p>
          ...
          <div className="mt-4 space-y-4">
            ...
            <div>
              ...
              <textarea
                value={transportPlan}
                onChange={(event) =>
                  setTransportPlan(event.target.value)
                }
        ...
        <section className="rounded-3xl bg-white p-5 shadow-sm">
          ...
          <p className="mt-1 text-sm leading-5 text-gray-500">
            Did your hospital give you a checklist of
          ...
          <div className="mt-4 grid grid-cols-2 gap-3">
            ...
            <button
              onClick={() =>
                handleChecklistChoice(true)
              }
              className={`rounded-2xl border p-4 text-left transition ${
                hasHospitalChecklist === true
            ...
            >
              ...
              <p className="mt-1 text-xs text-gray-500">
                Add my hospital's checklist
              </p>
            </button>

            <button
              onClick={() =>
                handleChecklistChoice(false)
              }
              className={`rounded-2xl border p-4 text-left transition ${
                hasHospitalChecklist === false
                  ? "border-pink-600 bg-pink-50"
                  : "border-gray-200 bg-white"
              }`}
            >
              ...
              <p className="mt-1 text-xs text-gray-500">
                Use HerBloom's general checklist
              </p>
            </button>
              ...
              {checklist.length === 0 ? (
                <div className="rounded-2xl bg-pink-50 p-4 text-center">
                  <p className="text-sm text-gray-600">
                    Your hospital checklist is empty.
            ...
            {hasHospitalChecklist && (
              <div className="mt-4 flex gap-2">
                ...
                <button
                  ...
                  className="rounded-xl bg-pink-600 px-4 py-3 font-semibold text-white"
                >
                  Add
                </button>
        ...
        <section className="rounded-3xl bg-white p-5 shadow-sm">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Record questions, preferences or things you
            would like to discuss with your healthcare team.
          </p>

          <textarea
            value={birthPreferences}
            onChange={(event) =>
              setBirthPreferences(event.target.value)
            }
        ...
        <section className="rounded-3xl bg-white p-5 shadow-sm">
          ...
          <div className="mt-4 space-y-3">
            ...
            <button
              onClick={addContact}
              className="w-full rounded-xl bg-pink-100 py-3 font-semibold text-pink-700"
            >
              + Add Contact
            </button>
              ...
              {contacts.map((contact) => (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-xs text-gray-500">
                      {contact.relationship || "Important contact"}
                    </p>
